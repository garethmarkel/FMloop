        ...
        <div>
          ...
          <div id="openingtitle" class="jumbotron jumbotron-fluid shadow bg-dark">
            <div class ="container h-75 py-5 bg-dark">
              <h2 style="text-align: center; font-family: helvetica, Arial; color: white;"> A new freelancing solution or some dumb text liek that</h2>
            </div>
          </div>
          <!-- End opening Jumbo -->
          <!-- Begin Carousel Opening -->
          ...
          <div class="row px-5">
            <div class="col">
          <h3 style="text-align: center;">Fm_loop, built by mongoloids
            <br>
          ...
          <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. </p>
            ...
            <div class="col">
            <h3 style="text-align: center;"> Freelancers love this shit
            </h3>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
            </div>
          <div class="col">
          <h3 style="text-align: center;"> Users hate us</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
          </div>
          </div>
          <!-- End Benefits Grid -->
          ...
          <div class="container px-5">
            <h3 style="text-align: center;">Placeholder for image map of user dash" </h3>
          </div>
          <!-- End image map -->
          <!-- Legal Jargon Start -->
          <div class="container px-5">
